/******
    ...
    It's the same popupforms.js without an action on onClick form (line 69)
******/
    ...
    $('#portal-personaltools a[href$="/login"], #portal-personaltools a[href$="/login_form"], .discussion a[href$="/login"], .discussion a[href$="/login_form"]').prepOverlay(
        {
            ...
            // We deselect the onclick function to avoid redirect over ours functionality.
            // comment out this line to get the initial file
            ...
            redirect: function () {
            return jq(body).find('a#original-url').attr('href') || location.href;
